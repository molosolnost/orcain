...
export default function Battle({ onBackToMenu, tokens, matchEndPayload, lastPrepStart, currentMatchId, matchMode }: BattleProps) {
  ...
  // Tutorial: Steps are controlled by server only (tutorial_step_state event)
  // No client-side auto-progression - server sends step updates after round completion
